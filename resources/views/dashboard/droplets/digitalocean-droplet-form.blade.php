...
<div class="container mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-10 animate-fade-in">
        <h1 class="text-3xl sm:text-4xl font-extrabold text-red-600 mb-4 tracking-tight">
             Spin Up a New Droplet (Virtual Machine)
        </h1>
    ...
    <!-- Form -->
    <form action="{{ route('create.droplet') }}" method="POST" class="max-w-3xl mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
        @csrf
        ...
        <div class="text-center mt-8">
            ...
            <!--<button type="submit"  id="createDropletBtn"
             class="bg-red-600 text-white py-3 px-8 rounded-lg hover:bg-red-700 
             transition-colors duration-300 shadow-md text-base sm:text-lg font-medium disabled:opacity-70 disabled:cursor-not-allowed">
                <span id="btnText">
                    Create Now
                </span>
            </button>-->
...
<script>
   ...
   document.querySelector("#createDropletBtn").addEventListener("click", () => {
        const btn = document.querySelector("#createDropletBtn");
